...
# create user
user_create_output = subprocess.check_output(['serverless', 'invoke', '--local', '--function', 'user-create', '--path', 'mocks/user-create-event.json', '--stage', 'prod'])
...
user_get_output = subprocess.check_output(['serverless', 'invoke', '--local', '--function', 'user-get', '--data', get_user_data, '--stage', 'prod'])
...
status_create_output = subprocess.check_output(['serverless', 'invoke', '--local', '--function', 'status-create', '--path', 'mocks/status-create-event.json', '--stage', 'prod'])
...
status_get_output = subprocess.check_output(['serverless', 'invoke', '--local', '--function', 'status-get', '--data', get_status_data, '--stage', 'prod'])
